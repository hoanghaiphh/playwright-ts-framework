...
export class ExcelDataService {
    ...
    private getCellValue(value: ExcelJS.CellValue): string | number | null {
    ...
    public async readExcelFile(relativePath: string, sheetName?: string): Promise<DataRow[]> {
        ...
        worksheet.eachRow((row, rowNumber) => {
            ...
            headers.forEach((header, index) => {
                ...
                const value = this.getCellValue(cellValue);
